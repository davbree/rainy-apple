...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/608001a920ad2d001962d1f1
...
To start editing your site, you can use the Sanity interface at https://rainy-apple-001a9.sanity.studio/.
...
Generated at `2021-04-21T10:43:16.826Z` by Stackbit version `0.3.50`.